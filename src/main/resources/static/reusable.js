    ...
    async load() {
        try {
            ...
            if (!res.ok) {
                ...
                console.error("API error for", this.apiBase, ":", errorData);
            ...
            if (responseData.content) {
                ...
                // Spring Page object structure: totalPages, totalElements, number, size, etc.
                if (typeof responseData.totalPages !== 'undefined') {
                    this.totalPages = responseData.totalPages;
                } else if (responseData.page && responseData.page.totalPages) {
                    this.totalPages = responseData.page.totalPages;
                } else {
                    this.totalPages = Math.ceil((responseData.totalElements || this.data.length) / this.pageSize);
                }
